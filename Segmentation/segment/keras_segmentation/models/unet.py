...
def unet_mini(n_classes, input_height=360, input_width=480, quantize_flag=0):
...
def unet(n_classes, input_height=416, input_width=608, encoder_level=3, quantize_flag=0):
...
def vgg_unet(n_classes, input_height=416, input_width=608, encoder_level=3, quantize_flag=0):
...
def resnet50_unet(n_classes, input_height=416, input_width=608,
                  encoder_level=3, quantize_flag=0):
