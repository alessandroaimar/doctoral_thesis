...
def get_segmentation_model(input, output, quantize_flag=0):
    ...
    if quantize_flag == "tnh":
        print("Enabling quantization")
        model = Quantizer.apply_quantization(model, weight_precision=16, activation_precision=16)
    elif quantize_flag == "sparsity":
        print("Enabling sparsity measure")
