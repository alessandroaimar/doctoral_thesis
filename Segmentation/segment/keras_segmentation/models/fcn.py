...
def fcn_8(n_classes, encoder=vanilla_encoder, input_height=416,
          input_width=608, quantize_flag=0):
    ...
    model = get_segmentation_model(img_input, o, quantize_flag)
...
def fcn_8_vgg(n_classes,  input_height=416, input_width=608, quantize_flag=0):
    model = fcn_8(n_classes, get_vgg_encoder,
                  input_height=input_height, input_width=input_width, quantize_flag=quantize_flag)
    model.model_name = "fcn_8_vgg"
    return model


def fcn_32_vgg(n_classes,  input_height=416, input_width=608, quantize_flag=0):
...
def fcn_8_resnet50(n_classes,  input_height=416, input_width=608, quantize_flag=0):
...
def fcn_32_resnet50(n_classes,  input_height=416, input_width=608, quantize_flag=0):
...
def fcn_8_mobilenet(n_classes,  input_height=416, input_width=608, quantize_flag=0):
...
def fcn_32_mobilenet(n_classes,  input_height=416, input_width=608, quantize_flag=0):
